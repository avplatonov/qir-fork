...
public class Time {
    /**
     * Format a time given in seconds in the format xd yh zm ts where x,y,z and t are the number of days, hours, minutes
    ...
    /**
     * Format a time given in milliseconds in the format xd yh zm ts xms where x,y,z and t are the number of days,
