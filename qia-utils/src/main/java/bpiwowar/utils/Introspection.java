...
public class Introspection {
     ...
     * @param levels The maximum number of recursion within the structure (or -1 if infinite)
     */
    ...
    public static void addClasses(final Checker checker,
        ...
        logger.debug(String.format("Exploring jar file %s with prefix %s", jfile.getName(),
            prefix));
