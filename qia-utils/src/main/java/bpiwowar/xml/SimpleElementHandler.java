...
/**
 * A <code>SimpleElementHandler</code> is a default handler that supplies utilities for simple elements and attributes.
 *
...
public class SimpleElementHandler extends DefaultHandler {
    ...
    /**
     * Converts the string to a character array in order to call {@link #characters(char[], int, int)} to handle the
     * characters.
     *
    ...
    /**
     * Handls the specified character array by delegation to {@link #characters(char[], int, int)}.
     *
    ...
    /**
     * Starts an element with a <code>null</code> namespace and no attributes.
     *
     * @param name Name of element to start.
     * @throws SAXException if the contained hanlder throws a SAX exception.
    ...
    /**
     * Starts an element with a <code>null</code> namespace and a single attribute and value.
     *
     * @param name Name of element to start.
    ...
    /**
     * Starts an element with a <code>null</code> namespace and a pair of attributes and values.
     *
     * @param name Name of element to start.
    ...
    /**
     * Starts an element with a <code>null</code> namespace and the specified local name, which is also provided as the
     * qualified name.
     *
    ...
    /**
     * End an element with a <code>null</code> namespace, using the local name for both local and qualified names.
     *
     ...
     * @throws SAXException If the contained handler throws a SAX exception.
     */
    ...
    /**
     * Add a local name and value to an attributes implementation as type <code>"CDATA"</code>.  Sets both local and
     * qualified name on attribute.
     *
     * @param atts Attributes to which the specified attribute and value are added.
    ...
    /**
     * An implementation of <code>Attributes</code> with no attributes.
     */
