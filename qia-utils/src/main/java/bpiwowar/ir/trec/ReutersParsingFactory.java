...
public class ReutersParsingFactory implements ParsingFactory {
    ...
    public static final ReutersParsingFactory INSTANCE = new ReutersParsingFactory();
     ...
     * Elements
     */
    public static final Element TITLE = newElement("title", true, true);
    public static final Element P = newElement("p", true, true);
    public static final Element TEXT = newElement("text", true, true);
    public static final Element NEWSITEM = newElement("newsitem", true, true);
    public static final Element HEADLINE = newElement("headline", true, true);

    static {
        NAME2ATTRIBUTE.defaultReturnValue(Attribute.UNKNOWN);
        NAME2ATTRIBUTE.rehash();
