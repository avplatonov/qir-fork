...
final public class MapIntersectionIterator<Key, Value, Result> implements
    ...
    static class Entry<U, V> implements
        HeapElement<MapIntersectionIterator.Entry<U, V>>,
    ...
    Heap<MapIntersectionIterator.Entry<Key, Value>> heap = new Heap<MapIntersectionIterator.Entry<Key, Value>>();
    ...
    private final Aggregator<java.util.Map.Entry<Key, Value>, Result> aggregator;
    ...
    public <T extends Iterable<? extends Map.Entry<Key, Value>>> MapIntersectionIterator(
        ...
        list = GenericHelper.newArrayList(iterables.length);
    ...
    public MapIntersectionIterator(Comparator<Key> comparator,
        ...
        this.aggregator = aggregator;
        this.comparator = comparator;
        list = GenericHelper.newArrayList(maps.length);
    ...
    public Pair<Key, Result> doNext() {
        ...
        do {
            ...
            do {
                ...
                logger.debug("(%d) %s: %s => %s", entry.entryIndex, u,
    ...
    @SuppressWarnings("unchecked") final private int compare(Key a, Key b) {
        if (comparator == null)
