...
import static bpiwowar.utils.Time.formatTimeInSeconds;
...
final public class TaskTimer extends Timer {
        ...
        synchronized public void print(long timestamp, PrintStream out) {
            ...
            if (total > 0) {
                if (count > 0) {
                    ...
                    out
                        .format(
                            ...
                            name,
                            formatTimeInSeconds((int)(elapsed / 1000)),
                            formatTimeInSeconds(etaSeconds), count,
                ...
                out.format("(%s, RT: %s) %d %s processed at %.1f/min", name,
                    formatTimeInSeconds((int)(elapsed / 1000)), count,
                    what, itemPerMinute);
            }
        }
    ...
    /**
     * Remove a task from this timer (this method is private since it is called by the task)
     *
