...
/**
 * A temporary directory that is automatically deleted when the JVM stops (or on demand)
 *
...
public class TemporaryDirectory {
    ...
    /**
     * Creates a temporary directory that will be automatically deleted at the end of the java program
     *
     * @param basedir
     * @param prefix
     * @param suffix
